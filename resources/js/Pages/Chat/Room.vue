...
<template>
    ...
    <main class="mx-auto flex h-[100dvh] max-w-4xl flex-col gap-3 px-3 py-3 sm:px-6 sm:py-5">
        ...
        <div ref="container" role="log" aria-label="Conversation messages" aria-live="polite" class="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto overscroll-contain rounded-2xl border border-border p-3 sm:p-5">
