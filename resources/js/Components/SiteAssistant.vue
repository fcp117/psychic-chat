...
const showAssistant=computed(()=>user.value && !page.component.startsWith('Auth/') && page.component!=='Error');
...
<template>
    ...
    <div v-if="showAssistant" class="fixed right-3 z-30 sm:right-5" :class="inRoom ? 'bottom-28' : 'bottom-5'" @keydown.esc="close">
